                    ...
                    notifications.map(n => (
                      ...
                      >
                        <div className="flex items-start gap-2">
                          ...
                          />
                          <div>
                            <p className="text-xs font-semibold" style={{ color: 'var(--text-primary)' }}>{ar ? n.title : (n.titleEn ?? n.title)}</p>
                            <p className="text-xs mt-0.5" style={{ color: 'var(--text-secondary)' }}>{ar ? n.message : (n.messageEn ?? n.message)}</p>
                          </div>
                        </div>
                      </div>
                    ))
 ...
 user?.role === 'admin'
   ...
   : (ar ? 'مزارع متقدم' : 'Senior Farmer')
            ...
            <button
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-xs transition-opacity hover:opacity-80"
              style={{ background: 'linear-gradient(135deg, #16a34a, #0891b2)' }}
            >
