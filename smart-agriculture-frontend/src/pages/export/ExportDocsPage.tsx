...
const SHIPMENTS: Shipment[] = [
  {
    ...
    quantity: '48 طن', quantityEn: '48 tons', value: '$640K', status: 'in-transit',
  ...
  },
  {
    ...
    quantity: '72 طن', quantityEn: '72 tons', value: '$840K', status: 'customs',
  ...
  },
  {
    ...
    quantity: '36 طن', quantityEn: '36 tons', value: '$520K', status: 'preparing',
  ...
  },
  {
    ...
    quantity: '18 طن', quantityEn: '18 tons', value: '$280K', status: 'delayed',
...
const DOCUMENTS: ExportDocument[] = [
  ...
  { id: 'd13', type: 'quality-cert', nameAr: 'شهادة الجودة', nameEn: 'Quality Certificate', shipmentId: 's2', destination: 'UAE', destinationFlag: '🇦🇪', status: 'pending', issuedDate: '—', expiryDate: '—', issuedBy: '—', fileSize: '—', required: true, notes: 'بانتظار مراجعة الجمارك الإماراتية', notesEn: 'Awaiting UAE customs review' },
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <p style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
                        {ar ? ship.cropAr : ship.cropEn} · {ar ? ship.quantity : ship.quantityEn} · {ship.containers} {ar ? 'حاويات' : 'containers'} · Grade <strong style={{ color: ship.qualityGrade === 'A+' ? 'var(--emerald)' : ship.qualityGrade === 'B+' ? 'var(--amber)' : 'var(--rose)' }}>{ship.qualityGrade}</strong>
                      </p>
                    </div>
